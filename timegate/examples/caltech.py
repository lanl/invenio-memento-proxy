...
class InvenioHandler(Handler):
    ...
    def get_all_mementos(self, requri):
        ...
        logging.info(f"URL split count: {count}")
        #print(count) 
        for i in url_split:
           if i == "records":
               j = url_split.index(i)
        ...
        #   if loc j = 
            ...
            logging.info(f"u_values[k]: {u_values[k]}")
